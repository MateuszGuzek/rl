...
from torchrl.trainers.helpers.models import DreamerConfig, make_dreamer_v2
...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    exp_name = generate_exp_name("DreamerV2", cfg.exp_name)
    logger = get_logger(
        logger_type=cfg.logger,
        logger_name="dreamer_v2",
        experiment_name=exp_name,
        wandb_kwargs={
            "project": "torchrl",
            "group": f"DreamerV2_{cfg.env_name}",
            "offline": cfg.offline_logging,
        },
    )
    video_tag = f"DreamerV2_{cfg.env_name}_policy_test" if cfg.record_video else ""
    ...
    world_model, model_based_env, actor_model, value_model, policy = make_dreamer_v2(
    ...
    # Losses
    world_model_loss = DreamerV2ModelLoss(world_model)
